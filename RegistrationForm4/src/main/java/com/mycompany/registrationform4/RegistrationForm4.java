...
package com.mycompany.registrationform4;
...
public class RegistrationForm4 extends JFrame {
    private JTextField nameField, emailField, usernameField, phoneField;
    private JPasswordField passwordField, confirmPasswordField;
    private JTextArea addressArea;
    private JButton registerButton, uploadButton, resetButton;
